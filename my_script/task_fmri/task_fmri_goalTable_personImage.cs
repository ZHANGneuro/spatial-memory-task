...
public class task_fmri_goalTable_personImage : MonoBehaviour {
...
//        "left","left","left","left","left","left","left","back","back","back","back","back","back","back"};
	...
	public Texture2D set_person_image(){
		int group = int.Parse(task_fmri.which_subject_group);

		//map123
		if ((group == 1 & string.Equals (task_fmri.which_map, "1"))|
			(group == 2 & string.Equals (task_fmri.which_map, "1"))|
			(group == 3 & string.Equals (task_fmri.which_map, "1"))){
			...
			if(string.Equals (task_fmri.which_person, "2")){
				string option = " ";;
			...
			if(string.Equals (task_fmri.which_person, "3")){
				string option = " ";;
		...
		//map132
		if ((group == 1 & string.Equals (task_fmri.which_map, "2"))|
			(group == 2 & string.Equals (task_fmri.which_map, "2"))|
			(group == 4 & string.Equals (task_fmri.which_map, "1"))){
			if(string.Equals (task_fmri.which_person, "1")){
				string option = " ";;
		...
		//map142
		if ((group == 1 & string.Equals (task_fmri.which_map, "3"))|
			(group == 3 & string.Equals (task_fmri.which_map, "2"))|
			(group == 5 & string.Equals (task_fmri.which_map, "1"))){
			if(string.Equals (task_fmri.which_person, "1")){
				string option = " ";;
		...
		//map124
		if ((group == 2 & string.Equals (task_fmri.which_map, "3"))|
			(group == 4 & string.Equals (task_fmri.which_map, "2"))|
			(group == 6 & string.Equals (task_fmri.which_map, "1"))){
			if(string.Equals (task_fmri.which_person, "1")){
				string option = " ";;
		...
		//map134
		if ((group == 3 & string.Equals (task_fmri.which_map, "3"))|
			(group == 5 & string.Equals (task_fmri.which_map, "2"))|
			(group == 6 & string.Equals (task_fmri.which_map, "2"))){
			if(string.Equals (task_fmri.which_person, "1")){
				string option = " ";;
		...
		//map143
		if ((group == 4 & string.Equals (task_fmri.which_map, "3"))|
			(group == 5 & string.Equals (task_fmri.which_map, "3"))|
			(group == 6 & string.Equals (task_fmri.which_map, "3"))){
			if(string.Equals (task_fmri.which_person, "1")){
				string option = " ";;
