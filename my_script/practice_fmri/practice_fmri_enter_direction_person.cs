...
public class practice_fmri_enter_direction_person : MonoBehaviour
{
	...
	public void create_initial_direction_pool_for_each_map()
	{
		...
		//		map123.Add(direction_315);
		//		map123.Add(direction_0);
		//		map123.Add(direction_22_5);
		//		map123.Add(direction_112_5);
		//		map123.Add(direction_157_5);
		//		map123.Add(direction_247_5);
		//		map123.Add(direction_270);
		//
		//		map124.Add(direction_225);
		//		map124.Add(direction_270);
		//		map124.Add(direction_292_5);
		//		map124.Add(direction_22_5);
		//		map124.Add(direction_67_5);
		//		map124.Add(direction_157_5);
		//		map124.Add(direction_180);
		//
		//		map134.Add(direction_135);
		//		map134.Add(direction_180);
		//		map134.Add(direction_202_5);
		//		map134.Add(direction_292_5);
		//		map134.Add(direction_337_5);
		//		map134.Add(direction_67_5);
		//		map134.Add(direction_90);
	}
	...
	public List<Vector3> setup_enter_direction_pool()
	{
		...
		if ((string.Equals(practice_fmri.which_subject_group, "1") & string.Equals(practice_fmri.which_map, "1")) |
			(string.Equals(practice_fmri.which_subject_group, "1") & string.Equals(practice_fmri.which_map, "2")) |
			(string.Equals(practice_fmri.which_subject_group, "2") & string.Equals(practice_fmri.which_map, "1")) |
			(string.Equals(practice_fmri.which_subject_group, "2") & string.Equals(practice_fmri.which_map, "2")) |
			(string.Equals(practice_fmri.which_subject_group, "3") & string.Equals(practice_fmri.which_map, "1")) |
			(string.Equals(practice_fmri.which_subject_group, "4") & string.Equals(practice_fmri.which_map, "1")))
		{
			initial_direction_pool = map123;
		}
		if ((string.Equals(practice_fmri.which_subject_group, "1") & string.Equals(practice_fmri.which_map, "3")) |
			(string.Equals(practice_fmri.which_subject_group, "2") & string.Equals(practice_fmri.which_map, "3")) |
			(string.Equals(practice_fmri.which_subject_group, "3") & string.Equals(practice_fmri.which_map, "2")) |
			(string.Equals(practice_fmri.which_subject_group, "4") & string.Equals(practice_fmri.which_map, "2")) |
			(string.Equals(practice_fmri.which_subject_group, "5") & string.Equals(practice_fmri.which_map, "1")) |
			(string.Equals(practice_fmri.which_subject_group, "6") & string.Equals(practice_fmri.which_map, "1")))
		{
			initial_direction_pool = map124;
		}
		if ((string.Equals(practice_fmri.which_subject_group, "3") & string.Equals(practice_fmri.which_map, "3")) |
			(string.Equals(practice_fmri.which_subject_group, "4") & string.Equals(practice_fmri.which_map, "3")) |
			(string.Equals(practice_fmri.which_subject_group, "5") & string.Equals(practice_fmri.which_map, "2")) |
			(string.Equals(practice_fmri.which_subject_group, "5") & string.Equals(practice_fmri.which_map, "3")) |
			(string.Equals(practice_fmri.which_subject_group, "6") & string.Equals(practice_fmri.which_map, "2")) |
			(string.Equals(practice_fmri.which_subject_group, "6") & string.Equals(practice_fmri.which_map, "3")))
		{
