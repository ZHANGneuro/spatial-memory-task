...
public class practice_fmri_goalTable_personImage : MonoBehaviour {
	...
	public Texture2D set_person_image(){
		int group = int.Parse(practice_fmri.which_subject_group);


		//map123
		if ((group == 1 & string.Equals (practice_fmri.which_map, "1"))|
			(group == 2 & string.Equals (practice_fmri.which_map, "1"))|
			(group == 3 & string.Equals (practice_fmri.which_map, "1"))){
			if(string.Equals (practice_fmri.which_person, "1")){


				string option = " ";
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
				}
				if (practice_fmri.exp_stage == 3) { 
					option= practice_fmri.practice_formal_stage3_DataSet [practice_fmri.trial_ith_formal_exp_stage3] [3];
				}


				if (practice_fmri.exp_stage == 4){
			...
			if(string.Equals (practice_fmri.which_person, "2")){
				string option = " ";;
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
				}
			...
			if(string.Equals (practice_fmri.which_person, "3")){
				string option = " ";
		...
		//map132
		if ((group == 1 & string.Equals (practice_fmri.which_map, "2"))|
			(group == 2 & string.Equals (practice_fmri.which_map, "2"))|
			(group == 4 & string.Equals (practice_fmri.which_map, "1"))){
			if(string.Equals (practice_fmri.which_person, "1")){
				string option = " ";;
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
		...
		//map142
		if ((group == 1 & string.Equals (practice_fmri.which_map, "3"))|
			(group == 3 & string.Equals (practice_fmri.which_map, "2"))|
			(group == 5 & string.Equals (practice_fmri.which_map, "1"))){
			if(string.Equals (practice_fmri.which_person, "1")){
				string option = " ";;
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
		...
		//map124
		if ((group == 2 & string.Equals (practice_fmri.which_map, "3"))|
			(group == 4 & string.Equals (practice_fmri.which_map, "2"))|
			(group == 6 & string.Equals (practice_fmri.which_map, "1"))){
			if(string.Equals (practice_fmri.which_person, "1")){
				string option = " ";;
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
		...
		//map134
		if ((group == 3 & string.Equals (practice_fmri.which_map, "3"))|
			(group == 5 & string.Equals (practice_fmri.which_map, "2"))|
			(group == 6 & string.Equals (practice_fmri.which_map, "2"))){
			if(string.Equals (practice_fmri.which_person, "1")){
				string option = " ";;
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
		...
		//map143
		if ((group == 4 & string.Equals (practice_fmri.which_map, "3"))|
			(group == 5 & string.Equals (practice_fmri.which_map, "3"))|
			(group == 6 & string.Equals (practice_fmri.which_map, "3"))){
			if(string.Equals (practice_fmri.which_person, "1")){
				string option = " ";;
				if (practice_fmri.exp_stage == 2) { 
					option= practice_fmri.practice_formal_stage2_DataSet [practice_fmri.trial_ith_formal_exp_stage2] [3];
