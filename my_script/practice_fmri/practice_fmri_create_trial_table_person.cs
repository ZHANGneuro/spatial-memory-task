...
public class practice_fmri_create_trial_table_person : MonoBehaviour {
	...
	public void create_trial_table(){
        ...
        // practice stage 1
        practice_fmri.practice_formal_stage1_DataSet = new String[4][];
        ...
        practice_fmri.practice_formal_stage1_DataSet[0] = stage1_trial1;
        ...
        practice_fmri.practice_formal_stage1_DataSet[1] = stage1_trial2;
        ...
        practice_fmri.practice_formal_stage1_DataSet[2] = stage1_trial3;
        ...
        practice_fmri.practice_formal_stage1_DataSet[3] = stage1_trial4;
        ...
        practice_fmri.practice_formal_stage2_DataSet = new String[formal_practie2_List.Count][];
        for (int i = 0; i < formal_practie2_List.Count; i++)
        {
            string[] entries = formal_practie2_List[i].Split('\t');
            for (int j = 0; j < entries.Length; j++)
            {
                practice_fmri.practice_formal_stage2_DataSet[i] = entries;
            }
        }

        // practice stage 3 for formal
        TextAsset formal_practie3_asset = (TextAsset)Resources.Load("dataset_formal_practice_stage3");
        List<string> formal_practie3_List = TextAssetToList(formal_practie3_asset);

        practice_fmri.practice_formal_stage3_DataSet = new String[formal_practie3_List.Count][];
        for (int i = 0; i < formal_practie3_List.Count; i++)
        {
            string[] entries = formal_practie3_List[i].Split('\t');
            for (int j = 0; j < entries.Length; j++)
            {
                practice_fmri.practice_formal_stage3_DataSet[i] = entries;
            }
        }
    }
