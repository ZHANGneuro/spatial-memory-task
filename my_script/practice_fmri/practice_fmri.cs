...
public class practice_fmri : MonoBehaviour{
...
//	bool target_finish = false;
	...
	void ShowGUI(int windowID){
		...
		if (GUI.Button(new Rect( (250-100)/2, 200, 100, 30), "OK"))
		{
            ...
            practice_fmri_create_trial_table_person create_trial_table = wooden_fence.GetComponent<practice_fmri_create_trial_table_person> ();
...
//		target_finish = false;
	...
	void reset_subject_facing_direction(){
        practice_fmri_item_subject_person set_subject_facing_direction = wooden_fence.GetComponent<practice_fmri_item_subject_person> ();
		set_subject_facing_direction.set_subject_facing_direction ();

        practice_fmri_item_subject_person rotate_person = wooden_fence.GetComponent<practice_fmri_item_subject_person> ();
...
//		}
	...
	void show_goal_person_image(){
        ...
        practice_fmri_goalTable_personImage TargetImage = wooden_fence.GetComponent<practice_fmri_goalTable_personImage> ();
...
//		}
	...
	void initilzing(){
        ...
        practice_fmri_enter_direction_person create_initial_direction_pool = wooden_fence.GetComponent<practice_fmri_enter_direction_person> ();
		create_initial_direction_pool.create_initial_direction_pool_for_each_map ();

        // create_goal_table
        practice_fmri_goalTable_personImage create_goal_table = wooden_fence.GetComponent<practice_fmri_goalTable_personImage> ();
		create_goal_table.create_goal_table ();

        // load_person_image
        practice_fmri_goalTable_personImage load_person_image = wooden_fence.GetComponent<practice_fmri_goalTable_personImage> ();
