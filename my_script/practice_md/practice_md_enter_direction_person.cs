...
public class practice_md_enter_direction_person : MonoBehaviour
{
    ...
    public List<Vector3> setup_enter_direction_pool()
    {
        ...
        if ((string.Equals(practice_md.which_subject_group, "1") & string.Equals(practice_md.which_map, "1")) |
            (string.Equals(practice_md.which_subject_group, "1") & string.Equals(practice_md.which_map, "2")) |
            (string.Equals(practice_md.which_subject_group, "2") & string.Equals(practice_md.which_map, "1")) |
            (string.Equals(practice_md.which_subject_group, "2") & string.Equals(practice_md.which_map, "2")) |
            (string.Equals(practice_md.which_subject_group, "3") & string.Equals(practice_md.which_map, "1")) |
            (string.Equals(practice_md.which_subject_group, "4") & string.Equals(practice_md.which_map, "1")))
        {
            initial_direction_pool = map123;
        }
        if ((string.Equals(practice_md.which_subject_group, "1") & string.Equals(practice_md.which_map, "3")) |
            (string.Equals(practice_md.which_subject_group, "2") & string.Equals(practice_md.which_map, "3")) |
            (string.Equals(practice_md.which_subject_group, "3") & string.Equals(practice_md.which_map, "2")) |
            (string.Equals(practice_md.which_subject_group, "4") & string.Equals(practice_md.which_map, "2")) |
            (string.Equals(practice_md.which_subject_group, "5") & string.Equals(practice_md.which_map, "1")) |
            (string.Equals(practice_md.which_subject_group, "6") & string.Equals(practice_md.which_map, "1")))
        {
            initial_direction_pool = map124;
        }
        if ((string.Equals(practice_md.which_subject_group, "3") & string.Equals(practice_md.which_map, "3")) |
            (string.Equals(practice_md.which_subject_group, "4") & string.Equals(practice_md.which_map, "3")) |
            (string.Equals(practice_md.which_subject_group, "5") & string.Equals(practice_md.which_map, "2")) |
            (string.Equals(practice_md.which_subject_group, "5") & string.Equals(practice_md.which_map, "3")) |
            (string.Equals(practice_md.which_subject_group, "6") & string.Equals(practice_md.which_map, "2")) |
            (string.Equals(practice_md.which_subject_group, "6") & string.Equals(practice_md.which_map, "3")))
        {
