...
public class mark_direction_fmri_enter_direction_person : MonoBehaviour
{
...
//		direction_270 = new Vector3(270f, positionY, 250f);
    ...
    public List<Vector3> setup_enter_direction_pool()
    {
        ...
        if ((string.Equals(mark_direction_fmri.which_subject_group, "1") & string.Equals(mark_direction_fmri.which_map, "1")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "1") & string.Equals(mark_direction_fmri.which_map, "2")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "2") & string.Equals(mark_direction_fmri.which_map, "1")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "2") & string.Equals(mark_direction_fmri.which_map, "2")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "3") & string.Equals(mark_direction_fmri.which_map, "1")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "4") & string.Equals(mark_direction_fmri.which_map, "1")))
        {
            initial_direction_pool = map123;
        }
        if ((string.Equals(mark_direction_fmri.which_subject_group, "1") & string.Equals(mark_direction_fmri.which_map, "3")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "2") & string.Equals(mark_direction_fmri.which_map, "3")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "3") & string.Equals(mark_direction_fmri.which_map, "2")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "4") & string.Equals(mark_direction_fmri.which_map, "2")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "5") & string.Equals(mark_direction_fmri.which_map, "1")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "6") & string.Equals(mark_direction_fmri.which_map, "1")))
        {
            initial_direction_pool = map124;
        }
        if ((string.Equals(mark_direction_fmri.which_subject_group, "3") & string.Equals(mark_direction_fmri.which_map, "3")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "4") & string.Equals(mark_direction_fmri.which_map, "3")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "5") & string.Equals(mark_direction_fmri.which_map, "2")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "5") & string.Equals(mark_direction_fmri.which_map, "3")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "6") & string.Equals(mark_direction_fmri.which_map, "2")) |
            (string.Equals(mark_direction_fmri.which_subject_group, "6") & string.Equals(mark_direction_fmri.which_map, "3")))
        {
