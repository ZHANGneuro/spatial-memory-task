...
public class mark_direction_fmri_goalTable_personImage : MonoBehaviour {
...
//		map123_b1 = new List<string>(){"left","left","left","left","left","left","left","back","back","back","back","back","back","back",
//        "left","left","left","left","left","left","left","back","back","back","back","back","back","back"};
//		map123_b2 = new List<string>(){"left","left","left","left","left","left","left","right","right","right","right","right","right","right",
//        "left","left","left","left","left","left","left","right","right","right","right","right","right","right"};
//		map123_b3 = new List<string>(){"right","right","right","right","right","right","right","back","back","back","back","back","back","back",
//        "right","right","right","right","right","right","right","back","back","back","back","back","back","back"};
//
//		map132_b1 = new List<string>(){"left","left","left","left","left","left","left","back","back","back","back","back","back","back",
//        "left","left","left","left","left","left","left","back","back","back","back","back","back","back"};
//		map132_b2 = new List<string>(){"right","right","right","right","right","right","right","back","back","back","back","back","back","back",
...
//        "left","left","left","left","left","left","left","back","back","back","back","back","back","back"};
	...
	public Texture2D set_person_image(){
		int group = int.Parse(mark_direction_fmri.which_subject_group);

		//map123
		if ((group == 1 & string.Equals (mark_direction_fmri.which_map, "1"))|
			(group == 2 & string.Equals (mark_direction_fmri.which_map, "1"))|
			(group == 3 & string.Equals (mark_direction_fmri.which_map, "1"))){
			...
			if(string.Equals (mark_direction_fmri.which_person, "2")){
				string option = " ";
				map123_b2 = ShuffleList (map123_b2);
			...
			if(string.Equals (mark_direction_fmri.which_person, "3")){
				string option = " ";;
				map123_b3 = ShuffleList (map123_b3);
		...
		//map132
		if ((group == 1 & string.Equals (mark_direction_fmri.which_map, "2"))|
			(group == 2 & string.Equals (mark_direction_fmri.which_map, "2"))|
			(group == 4 & string.Equals (mark_direction_fmri.which_map, "1"))){
			if(string.Equals (mark_direction_fmri.which_person, "1")){
				string option = " ";
				map132_b1 = ShuffleList (map132_b1);
		...
		//map142
		if ((group == 1 & string.Equals (mark_direction_fmri.which_map, "3"))|
			(group == 3 & string.Equals (mark_direction_fmri.which_map, "2"))|
			(group == 5 & string.Equals (mark_direction_fmri.which_map, "1"))){
			if(string.Equals (mark_direction_fmri.which_person, "1")){
				string option = " ";
				map142_b1 = ShuffleList (map142_b1);
		...
		//map124
		if ((group == 2 & string.Equals (mark_direction_fmri.which_map, "3"))|
			(group == 4 & string.Equals (mark_direction_fmri.which_map, "2"))|
			(group == 6 & string.Equals (mark_direction_fmri.which_map, "1"))){
			if(string.Equals (mark_direction_fmri.which_person, "1")){
				string option = " ";
				map124_b1 = ShuffleList (map124_b1);
		...
		//map134
		if ((group == 3 & string.Equals (mark_direction_fmri.which_map, "3"))|
			(group == 5 & string.Equals (mark_direction_fmri.which_map, "2"))|
			(group == 6 & string.Equals (mark_direction_fmri.which_map, "2"))){
			if(string.Equals (mark_direction_fmri.which_person, "1")){
				string option = " ";
				map134_b1 = ShuffleList (map134_b1);
		...
		//map143
		if ((group == 4 & string.Equals (mark_direction_fmri.which_map, "3"))|
			(group == 5 & string.Equals (mark_direction_fmri.which_map, "3"))|
			(group == 6 & string.Equals (mark_direction_fmri.which_map, "3"))){
			if(string.Equals (mark_direction_fmri.which_person, "1")){
				string option = " ";
				map143_b1 = ShuffleList (map143_b1);
